...
<body>
    <div class="receipt">
        ...
        <div class="section">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="value">{{ $reservation->start_date->format('M d, Y') }} –
                ...
                <tr>
                    ...
                    <td class="value">{{ $reservation->requires_driver ? 'Yes, driver assigned' : 'No (self-drive)' }}
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="section">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="value">{{ ucfirst($reservation->car->fuel_type) }} ·
        ...
        <div class="section">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="value">{{ $payment->provider }}
                        ({{ str_replace('_', ' ', ucfirst($payment->payment_method)) }})</td>
                </tr>
                <tr>
                    <td class="label">Customer reference</td>
                    <td class="value">
                        {{ $payment->meta['customer_reference'] ?? $reservation->payment_reference ?? '—' }}
                    </td>
                </tr>
                <tr>
                    <td class="label">Paid at</td>
                    <td class="value">{{ optional($payment->paid_at ?? $payment->created_at)->format('M d, Y H:i') }}
                    </td>
                </tr>
            </table>
            ...
            @if(!empty($receiptPreview))
                <div class="card">
                    ...
                    <img src="{{ $receiptPreview }}" alt="Receipt preview"
                        style="width:100%; border-radius:0.75rem; border:1px solid #e2e8f0;">
                </div>
            @else
        ...
        <p class="muted" style="margin-top:1.5rem;">Thank you for choosing EthioRental. Please keep this confirmation
            for your records.</p>
    </div>
</body>
