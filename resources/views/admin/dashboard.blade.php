                ...
                <div class="col-lg-3 col-md-6">
                    <div class="quick-action-card">
                        ...
                        <div class="quick-action-content">
                            ...
                            <a href="{{ route('admin.rentals.create') }}" class="btn-modern btn-modern-sm"
                                style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); color: white; box-shadow: 0 4px 15px rgba(245, 158, 11, 0.35);">
                                <i class="bi bi-plus"></i> Create
                            </a>
                        </div>
                    </div>
