            ...
            <div class="col-lg-8">
                <div class="modern-card">
                    ...
                    <div class="modern-card-body">
                        <div class="row g-4">
                            <div class="col-md-6">
                                <label for="name" class="form-label-modern">Full Name <span
                            ...
                            <div class="col-md-6">
                                <label for="email" class="form-label-modern">Email Address <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label for="password_confirmation" class="form-label-modern">Confirm Password <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label for="phone" class="form-label-modern">Phone Number <span
                                        class="text-danger">*</span></label>
                ...
                <div class="modern-card mt-4">
                    ...
                    <div class="modern-card-body">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <label for="state" class="form-label-modern">State/Province <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control-modern @error('state') is-invalid @enderror"
                                    id="state" name="state" value="{{ old('state') }}" placeholder="Enter state" required>
                                @error('state')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <label for="country" class="form-label-modern">Country <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control-modern @error('country') is-invalid @enderror"
                ...
                <div class="modern-card-body">
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input type="text"
                                class="form-control-modern @error('driving_license_number') is-invalid @enderror"
                                id="driving_license_number" name="driving_license_number"
                                value="{{ old('driving_license_number') }}" placeholder="Enter license number">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date"
                                class="form-control-modern @error('driving_license_expiry') is-invalid @enderror"
            ...
            <div class="modern-card">
                ...
                <div class="modern-card-body">
                    <div class="mb-4">
                        ...
                        <select class="form-control-modern @error('role_id') is-invalid @enderror" id="role_id"
