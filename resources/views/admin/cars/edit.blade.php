                ...
                <div class="modern-card-body">
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control-modern @error('plate_number') is-invalid @enderror" id="plate_number" name="plate_number" value="{{ old('plate_number', $car->plate_number) }}" required>
                            @error('plate_number')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control-modern @error('make') is-invalid @enderror" id="make" name="make" value="{{ old('make', $car->make) }}" required>
                            @error('make')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control-modern @error('model') is-invalid @enderror" id="model" name="model" value="{{ old('model', $car->model) }}" required>
                            @error('model')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control-modern @error('year') is-invalid @enderror" id="year" name="year" value="{{ old('year', $car->year) }}" min="1900" max="{{ date('Y') + 1 }}" required>
                            @error('year')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control-modern @error('color') is-invalid @enderror" id="color" name="color" value="{{ old('color', $car->color) }}" required>
                            @error('color')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control-modern @error('seats') is-invalid @enderror" id="seats" name="seats" value="{{ old('seats', $car->seats) }}" min="1" max="50" required>
                            @error('seats')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control-modern @error('mileage') is-invalid @enderror" id="mileage" name="mileage" value="{{ old('mileage', $car->mileage) }}" min="0">
                            @error('mileage')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control-modern @error('description') is-invalid @enderror" id="description" name="description" rows="3">{{ old('description', $car->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-3 col-6">
                            <div class="feature-checkbox">
                                <input type="checkbox" class="form-check-input" id="feature_ac" name="features[]" value="air_conditioning" {{ in_array('air_conditioning', $features) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3 col-6">
                            <div class="feature-checkbox">
                                <input type="checkbox" class="form-check-input" id="feature_nav" name="features[]" value="navigation" {{ in_array('navigation', $features) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3 col-6">
                            <div class="feature-checkbox">
                                <input type="checkbox" class="form-check-input" id="feature_bluetooth" name="features[]" value="bluetooth" {{ in_array('bluetooth', $features) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3 col-6">
                            <div class="feature-checkbox">
                                <input type="checkbox" class="form-check-input" id="feature_sunroof" name="features[]" value="sunroof" {{ in_array('sunroof', $features) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3 col-6">
                            <div class="feature-checkbox">
                                <input type="checkbox" class="form-check-input" id="feature_leather" name="features[]" value="leather_seats" {{ in_array('leather_seats', $features) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3 col-6">
                            <div class="feature-checkbox">
                                <input type="checkbox" class="form-check-input" id="feature_cruise" name="features[]" value="cruise_control" {{ in_array('cruise_control', $features) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3 col-6">
                            <div class="feature-checkbox">
                                <input type="checkbox" class="form-check-input" id="feature_camera" name="features[]" value="backup_camera" {{ in_array('backup_camera', $features) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3 col-6">
                            <div class="feature-checkbox">
                                <input type="checkbox" class="form-check-input" id="feature_parking" name="features[]" value="parking_sensors" {{ in_array('parking_sensors', $features) ? 'checked' : '' }}>
            ...
            <div class="modern-card mb-4">
                ...
                <div class="modern-card-body">
                    <div class="mb-4">
                        ...
                        <input type="number" class="form-control-modern @error('daily_rate') is-invalid @enderror" id="daily_rate" name="daily_rate" value="{{ old('daily_rate', $car->daily_rate) }}" min="0" step="0.01" required>
                        @error('daily_rate')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" class="form-control-modern @error('weekly_rate') is-invalid @enderror" id="weekly_rate" name="weekly_rate" value="{{ old('weekly_rate', $car->weekly_rate) }}" min="0" step="0.01">
                        @error('weekly_rate')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-0">
                        ...
                        <input type="number" class="form-control-modern @error('monthly_rate') is-invalid @enderror" id="monthly_rate" name="monthly_rate" value="{{ old('monthly_rate', $car->monthly_rate) }}" min="0" step="0.01">
                        @error('monthly_rate')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="status-toggle">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input" id="is_available" name="is_available" value="1" {{ old('is_available', $car->is_available) ? 'checked' : '' }} style="width: 48px; height: 24px;">
                                </div>
                            </div>
                        </div>
                    </div>
