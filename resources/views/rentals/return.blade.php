            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-light border">
                        <strong>Total paid:</strong> ETB {{ number_format($rental->total_amount, 2) }}<br>
                        <strong>Potential overdue:</strong> {{ $overduePreviewDays > 0 ? 'ETB ' . number_format($overduePreviewFee, 2) : 'None if returned today' }}
                    </div>
                </div>
            </div>
        </div>
