  ...
  <body>
    ...
    <aside class="customer-sidebar" id="sidebar">
      ...
      <nav class="sidebar-menu">
        ...
        <ul class="sidebar-nav">
          <li class="sidebar-nav-item">
            <a href="{{ route('cars.index') }}" class="sidebar-nav-link {{ request()->routeIs('cars.*') ? 'active' : '' }}">
              <span class="sidebar-nav-icon"><i class="bi bi-car-front-fill"></i></span>
              Browse Cars
            </a>
          </li>
          <li class="sidebar-nav-item">
            <a href="{{ route('reservations.index') }}" class="sidebar-nav-link {{ request()->routeIs('reservations.*') ? 'active' : '' }}">
              <span class="sidebar-nav-icon"><i class="bi bi-calendar-check"></i></span>
              My Reservations
            </a>
          </li>
          <li class="sidebar-nav-item">
            <a href="{{ route('rentals.index') }}" class="sidebar-nav-link {{ request()->routeIs('rentals.*') ? 'active' : '' }}">
        ...
        <ul class="sidebar-nav">
          ...
          <li class="sidebar-nav-item">
            <a href="{{ route('admin.dashboard') }}" class="sidebar-nav-link {{ request()->routeIs('admin.*') ? 'active' : '' }}">
        ...
        <div class="header-right">
          ...
          <div class="dropdown header-user-dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-modern">
              ...
              <li><a class="dropdown-item" href="{{ route('reservations.index') }}"><i class="bi bi-calendar-check"></i> Reservations</a></li>
