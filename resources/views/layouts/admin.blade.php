  ...
  <body>
    ...
    <aside class="admin-sidebar" id="sidebar">
      <div class="sidebar-brand">
        ...
        <div class="sidebar-brand-text">Carola<span>Admin</span></div>
      </div>
      ...
      <nav class="sidebar-menu">
        ...
        <ul class="sidebar-nav">
          ...
          <li class="sidebar-nav-item">
            <a href="{{ route('admin.cars.index') }}" class="sidebar-nav-link {{ request()->routeIs('admin.cars.*') ? 'active' : '' }}">
          ...
          <li class="sidebar-nav-item">
            <a href="{{ route('admin.rentals.index') }}" class="sidebar-nav-link {{ request()->routeIs('admin.rentals.*') ? 'active' : '' }}">
              <span class="sidebar-nav-icon"><i class="bi bi-key"></i></span>
              Rentals
            </a>
          </li>
          <li class="sidebar-nav-item">
            <a href="{{ route('admin.returns.index') }}" class="sidebar-nav-link {{ request()->routeIs('admin.returns.*') ? 'active' : '' }}">
      ...
      <header class="admin-header">
        ...
        <div class="header-right">
          <div class="header-quick-links">
            <a href="{{ route('home') }}" class="header-quick-link">
              <i class="bi bi-house me-1"></i> Home
            </a>
            <a href="{{ route('dashboard') }}" class="header-quick-link">
              <i class="bi bi-person me-1"></i> Customer View
            </a>
          </div>
